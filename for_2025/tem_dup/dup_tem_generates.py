...
from utils.utilities import lab_id_sort_key, random_calc_point_asb, calc_asb_percent, tem_calc_asb_percent
...
def get_tem_random_sample_from_project(samples_list, analyst): 
                    ...
                    if project_info['tem_count'] > 0 and project_info['tem_analysis']:
                        ...
                        if duplicates_to_add > 0:
                            for i in range(duplicates_to_add):
                                sample_duplicate = get_tem_random_sample_from_project(project_info['tem_analysis'], analyst)
